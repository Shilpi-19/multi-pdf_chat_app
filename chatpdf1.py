...
def get_conversational_chain():
    prompt_template = """
    You are an expert in analyzing and understanding documents.Give the proper response to the greetings as well. Answer the question as detailed as possible from the provided context, make sure to provide all the details, if the answer is not in
